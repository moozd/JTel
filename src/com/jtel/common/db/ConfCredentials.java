...
public class ConfCredentials implements Serializable {
    ...
    public ConfCredentials(int dc, byte[] authKey, byte[] serverSalt, long serverTime, byte[] authKeyId) {
    ...
    public ConfCredentials(byte[] auth_key, byte[] server_salt, long serverTime) {
