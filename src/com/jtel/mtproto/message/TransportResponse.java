...
public class TransportResponse {
    ...
    public TransportResponse( long messageId, byte[] messageBytes, TlObject response) {
    ...
    public TransportResponse(byte[] authKeyId, byte[] serverSalt, long messageId, int sequenceId, byte[] messageBytes, TlObject response) {
